  ...
  return (
    <main className="dev-page">
      ...
      <section>
        ...
        <p>{message}</p>
        <p>
          Authenticated: <strong>{authStatus.authenticated ? 'yes' : 'no'}</strong>
          {authStatus.userId ? (
            <>
      ...
      <section>
        ...
        <button type="button" disabled={busy} onClick={() => void inspectPreflight()}>
          Inspect deletion preflight
        </button>
        <button type="button" disabled={busy} onClick={() => void deleteAccount()}>
