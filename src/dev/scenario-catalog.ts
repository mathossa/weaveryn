...
export const devScenarioCatalog = [
  ...
  },
  {
    ...
    domain: 'Selection',
    purpose:
      'Exercise Campaign-specific Character entry cards and launcher hierarchy, per-entry pinning, recent-use tracking, Weaver resume context, and Threadwatcher World → Campaign selection with membership-scoped Campaign visibility through the real selection services.',
    href: '/dev/choose-entity-entry',
    issueNumbers: [51, 108, 143],
    prerequisites: [
      'Dedicated development database',
      'Applied Prisma migrations',
    ],
  ...
  },
  {
    ...
    domain: 'Worlds',
    purpose:
      'Exercise generic World entities, semantic fallback artwork, creator-selected artwork, reusable custom types, MVP visibility, explicit relationships, same-World validation, and backend authorization through the real World entity service.',
    href: '/dev/world-entities',
    issueNumbers: [20, 55, 114],
    prerequisites: [
      'Dedicated development database',
      'Applied Prisma migrations',
    ],
